...
echo "$($PSQL "select distinct(name) from teams t INNER JOIN games g ON t.team_id = g.winner_id OR t.team_id = g.opponent_id where year = 2014 and round = 'Eighth-Final'")"
